...
class StudentView(APIView):
    ...
    def get(self, request, pk=None):
        ...
        #check if user has provided any student_id, if the student id is provided then only one student 
        # with that id is retreived from the database. Otherwise all students will be retrieved and 
        # returned as JSON. In this case StudentSerilizer is serializing the Django model object into JSON.
    ...
    def put(self, request, pk=None):
        ...
        #partial=True to allow the user to pass some or all fields in payload
